...
function Game()
{
	...
	word = word.toUpperCase(); // stores the word the player is trying to guess
	let guessedLetters = []; // array, stores letters as the player guesses them
	let maskedWord = ""; // w_rds w_th _und_rs_o_es
	let incorrectGuesses = 0; //counter storing the number of times player has guessed incorrectly, starts at 0
	let possibleGuesses = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'; // all the letters of the abc, removed as they're guessed
	let won = false; // did they win
	let lost = false; // did they lose
	const maxGuesses = 7;
